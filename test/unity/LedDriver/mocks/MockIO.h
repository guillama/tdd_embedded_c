...
#define IO_Read_ExpectAndReturn(offset, cmock_retval) IO_Read_CMockExpectAndReturn(__LINE__, offset, cmock_retval)
void IO_Read_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, ioAddress offset, ioData cmock_to_return);
#define IO_Write_Expect(offset, data) IO_Write_CMockExpect(__LINE__, offset, data)
